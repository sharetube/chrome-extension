...
const Profile: React.FC<ProfileProps> = ({ user, changePage }) => {
	...
	const [debouncedAvatarUrl, setDebouncedAvatarUrl] = useState<string>(
		user.avatar_url,
	);
	...
	}, [debouncedAvatarUrl, user.avatar_url]);
...
const ProfileForm: React.FC<ProfileFormProps> = ({
	...
	<section className="p-[16px]">
		...
		<div className="m-[0_0_12px]">
			...
			<Input name="avatar_url" value={avatarUrl} onChange={changeHandler} />
		</div>
