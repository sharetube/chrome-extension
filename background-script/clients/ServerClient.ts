...
import {
	type FromServerMessagePayloadMap,
...
class ServerClient {
	...
	public send<T extends ToServerMessageType>(
		type: T,
	...
	public addHandler<T extends FromServerMessageType>(
		type: T,
